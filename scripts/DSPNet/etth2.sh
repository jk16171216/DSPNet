...
#  --train_epochs 100 \
#  --patience 20 \
#  --itr 1 --batch_size 2048 --learning_rate 0.0005 #>logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log
...
#  --train_epochs 100 \
#  --patience 20 \
#  --itr 1 --batch_size 1024 --learning_rate 0.0005 #>logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log
